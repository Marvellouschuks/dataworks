    ...
    681: function(module, exports) {
        ...
        function() {
            ...
            t.addEventListener = function(e, t, s) {
                var r, a = (r = s ? this._captureListeners = this._captureListeners || {} : this._listeners = this._listeners || {})[e];
                return a && this.removeEventListener(e, t, s),
                (a = r[e]) ? a.push(t) : r[e] = [t],
                t
            }
            ,
            t.on = function(e, t, s, r, a, n) {
                return t.handleEvent && (s = s || t,
                t = t.handleEvent),
                s = s || this,
            ...
            t.dispatchEvent = function(e, t) {
                ...
                e.bubbles && this.parent) {
                    for (var r = this, a = [r]; r.parent; )
                        a.push(r = r.parent);
                    var n, i = a.length;
                    for (n = i - 1; n >= 0 && !e.propagationStopped; n--)
                        a[n]._dispatchEvent(e, 1 + (0 == n));
                    for (n = 1; i > n && !e.propagationStopped; n++)
                        a[n]._dispatchEvent(e, 3)
                } else
            ...
            t._dispatchEvent = function(e, t) {
                ...
                if (e && r) {
                    ...
                    e.removed = !1,
                    a = a.slice();
                    for (var n = 0; s > n && !e.immediatePropagationStopped; n++) {
                        var i = a[n];
                        i.handleEvent ? i.handleEvent(e) : i(e),
                        e.removed && (this.off(e.type, i, 1 == t),
                        e.removed = !1)
                    }
                }
            }
        ...
        function() {
            ...
            t._isCrossDomain = function(e) {
                ...
                return s.href = location.href,
                "" != t.hostname && (t.port != s.port || t.protocol != s.protocol || t.hostname != s.hostname)
            }
            ,
        ...
        function() {
            ...
            t.init = function(e, t, s) {
                ...
                this._basePath = t,
                this.setUseXHR(e),
                this._crossOrigin = !0 === s ? "Anonymous" : !1 === s || null == s ? "" : s
            }
            ,
                ...
                if (t) {
                    for (; t.length; ) {
                        ...
                        for (n = this._loadQueue.length - 1; n >= 0; n--)
                            if ((i = this._loadQueue[n].getItem()).id == r || i.src == r) {
                                this._loadQueue.splice(n, 1)[0].cancel();
                                break
                            }
                        for (n = this._loadQueueBackup.length - 1; n >= 0; n--)
                            if ((i = this._loadQueueBackup[n].getItem()).id == r || i.src == r) {
                        ...
                        if (a)
                            ...
                            for (var n = this._currentLoads.length - 1; n >= 0; n--) {
                                var i = this._currentLoads[n].getItem();
                                if (i.id == r || i.src == r) {
            ...
            t.reset = function() {
                ...
                for (var t = [], s = 0, r = this._loadQueueBackup.length; r > s; s++)
                    t.push(this._loadQueueBackup[s].getItem());
            ...
            t.installPlugin = function(e) {
                if (null != e && null != e.getPreloadHandlers) {
                    ...
                    if (t.scope = e,
                    null != t.types)
                        for (var s = 0, r = t.types.length; r > s; s++)
                            this._typeCallbacks[t.types[s]] = t;
                    if (null != t.extensions)
                        for (s = 0,
                        r = t.extensions.length; r > s; s++)
                            this._extensionCallbacks[t.extensions[s]] = t
                }
            }
            ,
            ...
            t.loadFile = function(e, t, s) {
                if (null == e) {
                    ...
                    return r.text = "PRELOAD_NO_FILE",
                    void this._sendError(r)
                }
                this._addItem(e, null, s),
            ...
            t.loadManifest = function(e, t, r) {
                ...
                if (e instanceof Array) {
                    if (0 == e.length)
                        return (i = new createjs.Event("error")).text = "PRELOAD_MANIFEST_EMPTY",
                        void this._sendError(i);
                    a = e
                    ...
                    if ("object" != typeof e)
                        return (i = new createjs.Event("error")).text = "PRELOAD_MANIFEST_NULL",
                        void this._sendError(i);
                    if (void 0 !== e.src) {
                        if (null == e.type)
                            e.type = s.MANIFEST;
                        else if (e.type != s.MANIFEST) {
                            var i;
                            (i = new createjs.Event("error")).text = "PRELOAD_MANIFEST_ERROR",
                            this._sendError(i)
                        }
                        a = [e]
                    } else
                        void 0 !== e.manifest && (a = e.manifest,
                        n = e.path)
                }
                for (var o = 0, u = a.length; u > o; o++)
                    this._addItem(a[o], n, r);
                !1 !== t ? this.setPaused(!1) : this.setPaused(!0)
            }
            ,
            t.load = function() {
            ...
            t._addItem = function(e, t, s) {
                ...
                if (null != r) {
                    var a = this._createLoader(r);
                    null != a && (this._loadQueue.push(a),
                    this._loadQueueBackup.push(a),
                    this._numItems++,
                    this._updateProgress(),
                    this.maintainScriptOrder && r.type == createjs.LoadQueue.JAVASCRIPT && a instanceof createjs.XHRLoader && (this._scriptOrder.push(r),
            ...
            t._createLoadItem = function(e, t, s) {
                ...
                if (a && null == a[1] && null == a[3])
                    if (t) {
                        ...
                        o = t + o,
                        null != i && u && null == u[1] && null == u[2] && (n = i + n)
                    } else
                        null != i && (n = i);
                if (r.src = n + r.src,
                r.path = n,
                (r.type == createjs.LoadQueue.JSON || r.type == createjs.LoadQueue.MANIFEST) && (r._loadAsJSONP = null != r.callback),
                r.type == createjs.LoadQueue.JSONP && null == r.callback)
                    throw new Error("callback is required for loading JSONP requests.");
                (void 0 === r.tag || null === r.tag) && (r.tag = this._createTag(r)),
                (void 0 === r.id || null === r.id || "" === r.id) && (r.id = o);
                var l = this._typeCallbacks[r.type] || this._extensionCallbacks[r.ext];
                if (l) {
                    var c = l.callback.call(l.scope, r.src, r.type, r.id, r.data, n, this);
                    if (!1 === c)
                        return null;
                    !0 === c || (null != c.src && (r.src = c.src),
                    null != c.id && (r.id = c.id),
                    null != c.tag && (r.tag = c.tag),
                    null != c.completeHandler && (r.completeHandler = c.completeHandler),
                    c.type && (r.type = c.type),
                    null != (a = this._parseURI(r.src)) && null != a[6] && (r.ext = a[6].toLowerCase()))
                }
            ...
            t._handleFileComplete = function(e) {
                var t = e.target
                  , s = t.getItem();
                if (this._loadedResults[s.id] = t.getResult(),
                t instanceof createjs.XHRLoader && (this._loadedRawResults[s.id] = t.getResult(!0)),
                this._removeLoadItem(t),
                this.maintainScriptOrder && s.type == createjs.LoadQueue.JAVASCRIPT) {
                    if (!(t instanceof createjs.TagLoader))
                        return this._loadedScripts[createjs.indexOf(this._scriptOrder, s)] = s,
                        void this._checkScriptLoadOrder(t);
                    this._currentlyLoadingScript = !1
                }
                if (delete s._loadAsJSONP,
                s.type == createjs.LoadQueue.MANIFEST) {
                    var r = t.getResult();
            ...
            t._checkScriptLoadOrder = function() {
                for (var e = this._loadedScripts.length, t = 0; e > t; t++) {
                    ...
                    if (!0 !== s) {
                        ...
                        (document.body || document.getElementsByTagName("body")[0]).appendChild(r),
                        this._processFinishedLoad(s),
            ...
            t._removeLoadItem = function(e) {
                for (var t = this._currentLoads.length, s = 0; t > s; s++)
                    if (this._currentLoads[s] == e) {
            ...
            t._updateProgress = function() {
                ...
                if (t > 0) {
                    for (var s = 0, r = 0, a = this._currentLoads.length; a > r; r++)
                        s += this._currentLoads[r].progress;
            ...
            t._createTag = function(e) {
                ...
                case createjs.LoadQueue.IMAGE:
                    ...
                    "" == this._crossOrigin || this._isLocal(e) || (t.crossOrigin = this._crossOrigin),
                    t;
                case createjs.LoadQueue.SOUND:
                    return (t = document.createElement("audio")).autoplay = !1,
                    t;
                case createjs.LoadQueue.JSON:
                case createjs.LoadQueue.JSONP:
                case createjs.LoadQueue.JAVASCRIPT:
                case createjs.LoadQueue.MANIFEST:
                    return (t = document.createElement("script")).type = "text/javascript",
                    t;
                case createjs.LoadQueue.CSS:
                    return (t = this.useXHR ? document.createElement("style") : document.createElement("link")).rel = "stylesheet",
                    t.type = "text/css",
                    t;
                case createjs.LoadQueue.SVG:
                    return this.useXHR ? t = document.createElement("svg") : (t = document.createElement("object")).type = "image/svg+xml",
                    t
                }
                return null
            }
            ...
            t._sendFileComplete = function(e, t) {
                if (!this._isCanceled()) {
                    ...
                    s.loader = t,
                    s.item = e,
                    s.result = this._loadedResults[e.id],
                    s.rawResult = this._loadedRawResults[e.id],
                    e.completeHandler && e.completeHandler(s),
                    this.hasEventListener("fileload") && this.dispatchEvent(s)
                }
            }
            ,
            ...
            r.init = function() {
                ...
                r.isFirefox = e.indexOf("Firefox") > -1,
                r.isOpera = null != window.opera,
                r.isChrome = e.indexOf("Chrome") > -1,
                r.isIOS = e.indexOf("iPod") > -1 || e.indexOf("iPhone") > -1 || e.indexOf("iPad") > -1
            }
            ,
            r.init(),
        ...
        function() {
            ...
            t.load = function() {
                ...
                0 == s && (s = createjs.LoadQueue.loadTimeout),
                this._loadTimeout = setTimeout(createjs.proxy(this._handleTimeout, this), s),
                ...
                (e.type == createjs.LoadQueue.SVG || e.type == createjs.LoadQueue.JSONP || e.type == createjs.LoadQueue.JSON || e.type == createjs.LoadQueue.MANIFEST || e.type == createjs.LoadQueue.JAVASCRIPT || e.type == createjs.LoadQueue.CSS) && (this._startTagVisibility = t.style.visibility,
            ...
            t._clean = function() {
                ...
                null != t && (t.onload = null,
                t.removeEventListener && t.removeEventListener("canplaythrough", this._tagCompleteProxy, !1),
                t.onstalled = null,
                t.onprogress = null,
                t.onerror = null,
                null != t.parentNode && e.type == createjs.LoadQueue.SVG && e.type == createjs.LoadQueue.JSON && e.type == createjs.LoadQueue.MANIFEST && e.type == createjs.LoadQueue.CSS && e.type == createjs.LoadQueue.JSONP && t.parentNode.removeChild(t)),
                ((e = this.getItem()).type == createjs.LoadQueue.JSONP || e.type == createjs.LoadQueue.MANIFEST) && (window[e.callback] = null)
            }
            ,
            t.toString = function() {
        ...
        function() {
            ...
            t._createXHR = function(e) {
                ...
                createjs.LoadQueue.isText(e.type) && s.overrideMimeType && s.overrideMimeType("text/plain; charset=utf-8"),
                this._xhrLevel = "string" == typeof s.responseType ? 2 : 1;
                var r;
                return r = e.method == createjs.LoadQueue.GET ? this.buildPath(e.src, e.values) : e.src,
                s.open(e.method || createjs.LoadQueue.GET, r, !0),
                t && s instanceof XMLHttpRequest && 1 == this._xhrLevel && s.setRequestHeader("Origin", location.origin),
                e.values && e.method == createjs.LoadQueue.POST && s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
                createjs.LoadQueue.isBinary(e.type) && (s.responseType = "arraybuffer"),
                this._request = s,
                !0
            }
            ,
            ...
            t._generateTag = function() {
                ...
                switch (e) {
                case createjs.LoadQueue.IMAGE:
                    return t.onload = createjs.proxy(this._handleTagReady, this),
                    "" != this._crossOrigin && (t.crossOrigin = "Anonymous"),
                    t.src = this.buildPath(this._item.src, this._item.values),
                    this._rawResponse = this._response,
                    this._response = t,
                    !1;
                case createjs.LoadQueue.JAVASCRIPT:
                    return (t = document.createElement("script")).text = this._response,
                    this._rawResponse = this._response,
                    this._response = t,
                    !0;
                case createjs.LoadQueue.CSS:
                ...
                case createjs.LoadQueue.SVG:
                    ...
                    return this._rawResponse = this._response,
                    null != r.documentElement ? (t.appendChild(r.documentElement),
                    this._response = t) : this._response = r,
                    !0;
                case createjs.LoadQueue.JSON:
                case createjs.LoadQueue.MANIFEST:
                    var a = {};
            ...
            t._parseXML = function(e, t) {
                ...
                try {
                    if (window.DOMParser)
                        ...
                        (s = new ActiveXObject("Microsoft.XMLDOM")).async = !1,
                        s.loadXML(e)
                } catch (e) {}
                return s
            }
            ...
            function str(e, t) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep)
                        for (n = rep.length,
                        s = 0; n > s; s += 1)
                            "string" == typeof rep[s] && ((a = str(r = rep[s], u)) && i.push(quote(r) + (gap ? ": " : ":") + a));
                    else
                        for (r in u)
                            Object.prototype.hasOwnProperty.call(u, r) && ((a = str(r, u)) && i.push(quote(r) + (gap ? ": " : ":") + a));
                    return a = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + o + "}" : "{" + i.join(",") + "}",
                    gap = o,
                    a
                }
            ...
            "function" != typeof JSON.parse && (JSON.parse = function(text, reviver) {
                function walk(e, t) {
                    ...
                    if (a && "object" == typeof a)
                        for (s in a)
                            Object.prototype.hasOwnProperty.call(a, s) && (void 0 !== (r = walk(a, s)) ? a[s] = r : delete a[s]);
...
//# sourceMappingURL=vendors~about~archiveposts~archivetaxonomy~generic~home~people~pipeline~post~presentation~scholar~technology.f613.js.map
